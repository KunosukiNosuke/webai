    ...
    $scope.isQuestionAnswered = function (index) {
      return $scope.answeredQuestions[index] === true;
    };
    if ($scope.isQuestionAnswered($scope.begin1)) {
      return;
  }
    window.onload = function () {
      ...
      $scope.first = function() {
          ...
          $scope.kiemTra = function(indexx){
            ...
            $scope.answeredQuestions[$scope.begin1] = true;
            $scope.indexx = 1;
